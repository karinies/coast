...
;; Typical input/output will be:
;;> (island/start alice)
;;> (island/start bob)
;;#(info "bridge@bob: saw ENTER" 0 bridge@bob)
;;#(info "bridge@bob: saw ENTER" 0 bridge@bob)
;;#(info "ingress@bob: saw ENTER" "CAC3E1421B63405B856CAC1AED9F00FE" ingress@bob)
;;#(info "bridge@alice: saw ENTER" 0 bridge@alice)
;;#(info "ingress@alice: saw ENTER" "5F12BC111F8B4ACA825303182094D922" ingress@alice)
;;#(info "bridge@alice: saw WHISPER" 1 bridge@alice)
;;  hello world from bob
;;> (island/destroy alice)
;;#(info "bridge@bob: saw EXIT" 1 bridge@bob)
