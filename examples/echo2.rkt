...
(define bob   (island/new 'bob   BOB/CURVE/SECRET   (lambda () (client/boot alice/curl/echo 9999 3))))
(define carol
  (island/new 'carol CAROL/CURVE/SECRET (lambda () (client/boot alice/curl/echo "thanks for the echo" 2))))
